          ...
          {isModalOpen && selectedAddress && (
            <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-10">
              <div className="bg-white p-4 rounded shadow-lg w-96">
                ...
                <TextField sx={{marginBottom: '10px'}} variant='filled' label='Estado (Ex.: SC)' size='small' fullWidth type='text' value={selectedAddress.state} required onChange={(e) => setSelectedAddress({ ...selectedAddress, state: e.target.value })}/>
                <TextField sx={{marginBottom: '10px'}} variant='filled' label='CEP (Ex.: 12345-123)' size='small' fullWidth type='text' value={selectedAddress.cep} required onChange={(e) => setSelectedAddress({ ...selectedAddress, cep: e.target.value })}/>
